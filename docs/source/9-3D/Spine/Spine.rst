...
.. raw:: html
   ...
   <div id="container3D" style="width:100%; height:600px; position:relative;">
       <div id="loading" style="position:absolute; top:50%; left:50%; transform:translate(-50%,-50%); color:#666; font-size:18px;">Loading 3D Spine Model...</div>
   </div>
   ...
   <script type="module">
       ...
       loader.load(
           '../../_static/spine.glb',   // path fixed for 9-3D/Spine/spine.rst
           function (gltf) {
           ...
           function (error) {
               loading.innerHTML = '<div style="color:#ff6b6b;">Error loading spine model. Check console for details.</div>';
