...
freeview \
  ...
  :overlay=/home/hz3752/PycharmProjects/brainimaging-lab-documentation/pipeline/eeg_fmri_pipelines/fmri_preprocessing/finger-tapping/rh.betas_thumb.mgz
...
#     :overlay=$PROJECT_DIR/rh.betas_pinkie.mgz  :overlay_threshold=0.1,1 :overlay_color=200,0,200