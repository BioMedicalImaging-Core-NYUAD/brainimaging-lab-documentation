...
function loadParameters()
    ...
    parameters.imageMap = containers.Map(...
        ...
        {'Hand_Thumb_Highlighted_H.png', 'Hand_Index_Highlighted_H.png', ...
         'Hand_Middle_Highlighted_H.png', 'Hand_Ring_Highlighted_H.png', ...
         'Hand_Pinky_Highlighted_H.png'} ...
    );
    ...
    parameters.ST_finger  = 'sixth';
     parameters.miImageMap = containers.Map(...
        ...
        {'Hand_Thumb_Highlighted_H.png', 'Hand_Index_Highlighted_H.png', ...
         'Hand_Middle_Highlighted_H.png', 'Hand_Ring_Highlighted_H.png', ...
         'Hand_Pinky_Highlighted_H.png', 'Hand_SixthFinger_Highlighted_H.png'} ...
    );
