...
%
% Identical to the lab template setup_display. Handles NYUAD lab (mode 1)
% and laptop/development (mode 2) display profiles.
...
% Check VPixx availability for buttonbox
