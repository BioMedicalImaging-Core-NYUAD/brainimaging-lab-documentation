...
switch command
    case 'eyestart'
        ...
        % mm 322+322 = 644 width mm ; 181+181 = 362 mm (projected image
        %Eyelink('Command', 'screen_phys_coords = %d %d %d %d',-322,322,-181,181);
        %Eyelink('Command', 'screen_distance = %d',880); % in mm (88 cm)
